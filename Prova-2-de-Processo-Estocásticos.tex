...
\NormalTok{stock\_data }\OtherTok{\textless{}{-}} \FunctionTok{Cl}\NormalTok{(}\FunctionTok{get}\NormalTok{(stock\_symbol))}

\CommentTok{\# Summary statistics}
\NormalTok{stock\_data}\SpecialCharTok{$}\NormalTok{BBAS3.SA.Close }\SpecialCharTok{|\textgreater{}} \FunctionTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
