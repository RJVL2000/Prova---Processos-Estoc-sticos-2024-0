...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, colback={shadecolor}, breakable, frame hidden, enhanced]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics{./questao-mudancas-acypreste_files/figure-pdf/unnamed-chunk-17-1.pdf}
